(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'BrnECTdY1jTz0sUbpVp9muUf6H9d5i4gFOqTaWKGPx9cfJ1M', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1187484229], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Disel Level', // Replaces Xively logo in the header
		dataDuration	= 'Weeek', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 10800, // Default interval for data to be displayed (in seconds)
